...
bucket_config = {  # 18s/it
    ...
    "256": {1: (0.8, 200), 16: (0.5, 24), 32: (0.5, 12), 64: (0.5, 6), 128: (0.8, 4)},
    "240p": {1: (0.8, 200), 16: (0.5, 23), 32: (0.5, 11), 64: (0.5, 6), 128: (0.5, 3)},
    "360p": {1: (0.5, 120), 16: (0.5, 11), 32: (0.5, 5), 64: (0.5, 2), 128: (0.5, 1)},
    "512": {1: (0.5, 120), 16: (0.5, 11), 32: (0.5, 5), 64: (0.5, 2), 128: (0.8, 1)},
    "480p": {1: (0.4, 80), 16: (0.6, 7), 32: (0.6, 3), 64: (0.6, 1), 128: (0.0, None)},
